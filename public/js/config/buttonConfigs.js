...
export const buttonConfigs = [
  {
    id: "get-userId",
    method: "GET",
    endpoint: "https://10.120.32.87/app/api/users",
    type: "id",
    needsIdOptions: true,
  },
  {
  ...
  },
  {
    id: "login-user",
    method: "POST",
    endpoint: "https://10.120.32.87/app/api/auth/login",
    type: "post",
  },
  {
    id: "register-user",
    method: "POST",
    endpoint: "https://10.120.32.87/app/api/auth/register",
    type: "post",
  },
  {
    id: "auth-user",
    method: "GET",
    endpoint: "https://10.120.32.87/app/api/auth/me",
    type: "GET",
  },
  {
    id: "logout-user",
    method: "GET",
    endpoint: "https://10.120.32.87/app/api/auth/logout",
    type: "get",
  },
  {
    id: "get-menu",
    method: "GET",
    endpoint: "https://10.120.32.87/app/api/menu",
    type: "get",
  },
  {
    id: "get-menu-id",
  ...
  },
  {
    id: "get-route",
    method: "GET",
    endpoint: "https://10.120.32.87/app/api/route/:olat/:olng/:lat/:lng",
    type: "get",
  },
  {
    id: "get-route",
    method: "GET",
    endpoint:
      "https://10.120.32.87/app/api/route/60.192059/24.945831/60.193059/24.946831",
    type: "get",
  },
  {
    id: "get-legs",
    method: "GET",
    endpoint:
      "https://10.120.32.87/app/api/route/legs/60.192059/24.945831/60.193059/24.946831",
    type: "get",
  },
];
